...
scalaring is a Scala project for distributed systems. It focuses on this technical goal: Simulate actor ring routing and failure detection traces.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 157, risk penalty 4, latency penalty 3, and weight bonus 2. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.

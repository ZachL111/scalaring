"""Regression checks for the scalaring casebook."""
...
from casebook.harness import assert_expected, scalaring_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(scalaring_summary(), assert_expected())
